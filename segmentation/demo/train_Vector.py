...
from dataset import C_Dataset
from torch.utils.data import DataLoader
import os
from torch.optim.lr_scheduler import ReduceLROnPlateau
from model import dist_loss,dist_loss_mul,color_loss
...
def train_model():
   ...
   # model.load_state_dict(torch.load(args.modelpath))
    # 加载数据集
    C_dataset = C_Dataset("/media/qulab/720EA7AE0EA76A351/WM/data/train_patch/")
