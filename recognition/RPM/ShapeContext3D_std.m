function [Cost]=ShapeContext3D_std(Points1in,Points2in,Points1lin,Points2lin,options,Normals1,Normals2)
%
...
% Process inputs
defaultoptions=struct('r_max',2,'r_min',1e-20,'r_bins',15,'a_bins',15,'rotate',0,'method',1,'maxdist',5);
...
C=Features2CostMatrix_std(F1,F2,Points1,Points2,options.maxdist);
C(C==1e100)=inf;
Cost=C;
