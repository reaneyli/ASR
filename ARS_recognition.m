...
clear all
close all
addpath('./recognition_src/RPM/');
addpath('./recognition_src/matlab_io_basicdatatype/');
...
for iter_file=1:length(L)
    ...
    output_filename=strcat('data\recog_sample\result\',filename_sub(1:length(filename_sub)-8));
