...
function [Cost]=ShapeContext3D_rpm(Points1in,Points2in,Points1lin,Points2lin,options,Normals1,Normals2)
%
...
defaultoptions=struct('r_max',2,'r_min',1e-9,'r_bins',8,'a_bins',8,'rotate',0,'method',1,'maxdist',5);
