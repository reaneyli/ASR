...
for iter_file=1:length(L)
    ...
    % do Recog
    output_filename=strcat('Y:\2.postgrad\16-liyuanyuan\C_elegent\registration\sc_mean_rpm_sc_ab(row_max)piecewise_affine+tps(iter25,20)\M\',filename_sub(1:length(filename_sub)-8));
    ...
    output_filename=strcat('Y:\2.postgrad\16-liyuanyuan\C_elegent\registration\sc_mean_rpm_sc_ab(row_max)piecewise_affine+tps(iter25,20)\rpm_sc\',filename_sub(1:length(filename_sub)-8));
...
%             S=apo_sub{ind_atlas2validsub_pre(i)};
    ...
    fclose(fid);
    output_filename_rename=strcat('Y:\2.postgrad\16-liyuanyuan\C_elegent\registration\sc_mean_rpm_sc_ab(row_max)piecewise_affine+tps(iter25,20)\rpm_sc\',filename_sub(1:length(filename_sub)-8));
    output_filename_rename=strcat(output_filename_rename,".marker");
    copyfile(output_filename, output_filename_rename);
    
    output_filename_swc=strcat('Y:\2.postgrad\16-liyuanyuan\C_elegent\registration\sc_mean_rpm_sc_ab(row_max)piecewise_affine+tps(iter25,20)\rpm_sc_swc\',filename_sub(1:length(filename_sub)-8));
...
%             end
    ...
    fclose(fid);
    output_filename_rename=strcat('Y:\2.postgrad\16-liyuanyuan\C_elegent\registration\sc_mean_rpm_sc_ab(row_max)piecewise_affine+tps(iter25,20)\rpm_sc_swc\',filename_sub(1:length(filename_sub)-8));
...
%                 load("B0310.2_RW10695_20131123_0002.mat",'m');
